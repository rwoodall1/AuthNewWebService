...
Partial Class Receipt
    ...
    Sub EmailReceipt()
        ...
        objMM.Body = "<table class='style1' width=840px align='center'> <tr><td align='center' width=420px colspan='2' style='font-weight: bolder'>Thank you! Your order# is " & DetailsView2.DataKey("orderid") _
         & "<br /> Your order was placed on " & Now.ToString & "</td></tr> <tr><td align='center' style='font-weight: bolder'>Billing Information</td><td align='center' width=420px style='font-weight: bold'>Shipping Information</td></tr>" _
