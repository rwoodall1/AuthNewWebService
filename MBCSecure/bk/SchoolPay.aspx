...
<body id="pagebody" background="Images/background.jpg" link="blue">
...
<div style="height: 36px">  
    <asp:RadioButtonList ID="rbpaytype" runat="server" 
     ...
     <div align="left" style="height: 132px">
     <div style="width: 414px; float: left; height: 130px;">
     <table style="height: 114px">
     <tr><td align="right"><asp:Label ID="Label3" runat="server" 
             Text="Amount To Be Paid:"></asp:Label>  </td><td>   
      ...
      <tr><td align="right" class="style1"> <asp:Label ID="Label6" runat="server" Text="Email Address:"></asp:Label></td>
          <td class="style1">  
          <asp:TextBox
       ...
       <tr><td align="right"><asp:Label ID="Label11" runat="server" Text="Invoice No."></asp:Label> </td><td>  
           <asp:Label ID="lblinvoice" runat="server" Text="0"></asp:Label></td></tr>
     </table>
...
<div align="left" style="height: 36px">
