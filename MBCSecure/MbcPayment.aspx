...
<div style="clear:left; height:0px"></div>
	...
	<div class="formDivs">
       ...
       <asp:TextBox ID="x_card_num" runat="server" Width="164px" MaxLength="16"></asp:TextBox>
...
<span class="error_text"><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
      ...
      <div class="formDivs">
          Address:<asp:TextBox ID="txtaddress" runat="server" Width="247px"></asp:TextBox>
          &nbsp;&nbsp;
<span class="error_text"><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
      ...
      <div class="formDivs">
          ...
          &nbsp;
<span class="error_text"><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
...
<asp:HiddenField ID="x_echeck_type" 
     ...
     <eo:MsgBox ID="MsgBox1" runat="server" BackColor="#EBEBEB" CloseButtonUrl="00070301" ControlSkinID="None" HeaderHtml="Dialog Title" Height="216px" Width="320px">
     ...
     <asp:SqlDataSource ID="dsorder" runat="server" 
        ...
        ConnectionString="<%$ ConnectionStrings:MbcConn %>" 
        ProviderName="<%$ ConnectionStrings:MbcConn.ProviderName %>"></asp:SqlDataSource>
        <asp:SqlDataSource ID="dsState" runat="server" ConnectionString="<%$ ConnectionStrings:MbcConn %>" ProviderName="<%$ ConnectionStrings:MbcConn.ProviderName %>" SelectCommand="SELECT abrv, name FROM states ORDER BY abrv"></asp:SqlDataSource>
                       
    <asp:SqlDataSource ID="dsOrderChk" runat="server" 
    ConnectionString="<%$ ConnectionStrings:MbcConn %>" 
