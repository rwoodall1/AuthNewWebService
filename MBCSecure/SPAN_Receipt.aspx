<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SPAN_Receipt.aspx.vb" Inherits="SPAN_receipt" %>
...
<tr>
<td align="left" class="style1">Nombre de la escuela:  
    <asp:Label ID="lblschname" 
        runat="server" Text='<%# bind("schname") %>' Font-Bold="True"></asp:Label></td>
    <td align="left" class="style1">Código de la escuela:
    <asp:Label ID="lblschcode" runat="server" Font-Bold="True" 
            Text='<%# bind("schcode") %>'></asp:Label> </td>
    <td class="style1" align="left">
        Fecha del pedido:<asp:Label ID="lblorderdate" runat="server" Font-Bold="True" 
            Text='<%# bind("orddate") %>'></asp:Label>
    </td>
</tr>
<tr>
<td align="left" class="style5">Dirección de correo electrónico:
    <asp:Label ID="lblemail" runat="server" Font-Bold="True" 
        Text='<%# bind("emailaddress") %>'></asp:Label> </td> 
       <td class="style4" align="left"> Identificación del pedido:
        <asp:Label ID="lblorderid" runat="server" Font-Bold="True" 
               Text='<%# bind("orderid") %>'></asp:Label>  </td>
    <td align="left">
        Tipo de Pago:<asp:Label ID="lblpaytype" runat="server" Font-Bold="True" 
            Text='<%# bind("paytype") %>'></asp:Label>
    </td>
</tr>
                <tr>
                    <td align="left" class="style5">
                        Identificación de la transacción:<asp:Label ID="lbltansactionid" runat="server" 
                            Text='<%# bind("transid") %>' Font-Bold="True"></asp:Label>
                    </td>
                    <td align="left" class="style4">
                       Código de autorización:<asp:Label ID="lblauthcode" runat="server" Font-Bold="True" 
...
En caso de consultas acerca de su pedido del anuario, comuníquese con el asesor de anuarios de su escuela.
</div>
...
<div align="right" style="height: 31px; float: right;">
    ...
    <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" 
        Font-Size="Medium" ForeColor="Blue">Recepción de correo electrónico</asp:LinkButton>
    </div>
