...
<form id="form1" runat="server">
	<div class="hidden-xs headline">Thank you for your payment
        <br />
        <div style="font-size: medium">
        
            <asp:Label ID="lblmessge" runat="server" Text="If you have an ad you will be redirected in 5 seconds to a site to create your ad."></asp:Label>
        
        </div>
	</div>
    <div class="visible-xs headline2">Thank you for your payment
        <br />
        <asp:Label ID="Label2" runat="server" Text="If you have an add you will be redirected in 5 seconds to a site to create your ad."></asp:Label>
    </div>
    <div>
...
For questions about your yearbook order contact you schools yearbook advisor.<br />
    <p class="MsoNormal">
        <span> <asp:Label ID="lbladinfo" runat="server" Text="Don’t have time to finish your ad?  Visit this site to complete ad within 48 hours:" Visible="False"></asp:Label>
        &nbsp;<asp:LinkButton ID="lbAdSite" runat="server" ForeColor="Blue" PostBackUrl="http://mbcadpages.v5.pressero.com/category" Visible="False">http://mbcadpages.v5.pressero.com/category</asp:LinkButton>
        </span>
    </p>
<br />
<a href="https://products.memorybook.com/login">Click to order a 2016 graduate banner. The perfect companion to your 2016 yearbook.</a>
</div>
<div style="clear:left"></div>
